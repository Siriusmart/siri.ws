...
fetch("/home/logo/pfp.svg").then((res) => {
    res.text().then((svgContent) => {
        document.getElementById("logo").outerHTML = svgContent;
        ...
        for (let circle of Array.from(circles)) {
            ...
            copiedCircle.onmouseover = function () {
                ...
                setTimeout(() => {
                    ...
                    copiedCircle.setAttribute("r", 100);
                }, 20);
            };
